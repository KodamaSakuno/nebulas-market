export declare global {
    ...
    declare const LocalContractStorage: ContractStorage;
    ...
    interface IContractConstructor {
        new(address: string): IContract;
    }
    ...
    interface IBlockchain {
        ...
        Contract: IContractConstructor,
    }
    declare const Blockchain: IBlockchain;
}
